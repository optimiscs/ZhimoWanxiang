...
class NewsService:
            ...
            with app.app_context():
                ...
                try:
                    ...
                    try:
                        ...
                        # # 使用后备方案生成数据
                        # from ..utils.data_utils import https://dashscope.aliyuncs.com/compatible-mode/v1
                        # result = https://dashscope.aliyuncs.com/compatible-mode/v1(title)
                    ...
                    try:
                        # 尝试生成后备数据
                        from ..utils.data_utils import https://dashscope.aliyuncs.com/compatible-mode/v1
                        fallback = https://dashscope.aliyuncs.com/compatible-mode/v1(title)
    ...
    def update_current_hot_news(cls, n=None):
        """
        从hot_news_processed中找出最新的记录，从data[0].data里找出heat_sum最高的前n条热搜，
        ...
        try:
            ...
            # 步骤2: 从最新记录的data[0].data中获取前n条热搜（按heat_sum排序）
            try:
