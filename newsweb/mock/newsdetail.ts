export default {
  ...
  'GET /api/videoanalysisdata': {
    ...
    summary:
      "央视新闻曝光一次性内裤行业黑幕，部分企业宣称产品'EO灭菌''纯棉材质'，实则生产环境脏乱、未按标准消毒。工厂随意堆放原料，工人徒手操作，甚至用普通水枪代替专业消毒设备。产品销往酒店、美容院等场所，但多数客户为降低成本省去灭菌环节，仅贴标签应付检查。",
    sentimentAnalysis: {
      videoSentiment: {
        negative: 0.8,
        neutral: 0.15,
  ...
  'GET /api/opinion': [
    {
      ...
      title: '生产环节卫生隐患触目惊心',
      content:
        "央视315晚会曝光河南商丘多家企业生产环境恶劣，工人徒手操作、原材料与垃圾混杂堆放等问题引发强烈反响。调查显示，梦阳服饰等企业生产车间未配备基本防护措施，工人直接用手接触内裤成品；健芝初医疗器械公司使用具有腐蚀性的'枪水'掩盖污渍而非灭菌处理。原材料存在以涤纶冒充纯棉的材质造假行为，外包装标签伪造环氧乙烷灭菌标识。涉事企业代工品牌包括'初医生''贝姿妍''浪莎'等知名品牌，产品通过电商平台流向全国。医学专家指出，未经灭菌处理的内裤可能导致皮肤过敏、尿路感染等健康风险，消费者纷纷表示'看着包装标注的灭菌标识购买，没想到全是谎言'。",
      sentiment: 'negative',
    ...
    },
    {
      ...
      title: '虚假宣传突破行业底线',
      content:
        "涉事企业系统性伪造质量文件的行为引发行业信任危机。调查发现代工厂通过三种方式欺骗消费者：一是制作虚假环氧乙烷灭菌视频应付检查；二是伪造第三方检测报告；三是在未灭菌产品包装上直接印刷灭菌标识。部分企业甚至建立两套账本，仅对抽检批次进行象征性灭菌。浪莎等品牌旗舰店紧急下架产品后，消费者在直播间质问'灭菌标是不是贴纸游戏'。行业观察人士指出，该乱象暴露了代工模式下品牌方对供应链监管的严重缺失，'EO灭菌每个产品增加0.3元成本，企业为利润直接跳过核心环节'。法律专家援引《产品质量法》第十三条，强调涉事企业已涉嫌生产不符合安全标准产品罪。",
      sentiment: 'negative',
    ...
    },
    {
      ...
      title: '消费者信任崩塌引发连锁反应',
      content:
        "舆情监测显示，事件曝光后72小时内'一次性内裤'相关负面声量增长478%。典型消费者反馈包括：产后女性担忧'月子期间使用问题产品可能引发感染'，差旅人群表示'不敢再图方便购买'，过敏体质消费者发起集体维权。明星郭晓婷在社交媒体曝光'内裤发现霉斑异物'的图文获得超百万转发，推动#一次性内裤黑幕#登上微博热搜榜首。电商平台数据显示，事件导致行业整体销售额下降62%，部分消费者转向反复水洗传统棉质内裤。值得关注的是，医用级灭菌内裤搜索量激增320%，但专业人士提醒'所谓医用级缺乏国家标准，可能形成新的消费陷阱'。",
      sentiment: 'negative',
    ...
    },
    {
      ...
      title: '监管重拳整治行业乱象',
      content:
        "事件曝光后，商丘市监局连夜查封涉事企业生产线，封存成品、半成品共计1200万件。国家药监局启动医疗器械类目专项整治，要求各省市对一次性卫生用品生产企业进行全覆盖检查。值得关注的是，浪莎股份因代工问题收到上交所监管函，股价次日跌停。行业协会紧急出台《一次性卫生用品生产自律公约》，要求企业建立原材料溯源系统和灭菌过程视频存档制度。但舆论场仍存质疑声，'315打假年年有，治标更要治本''监管部门应建立生产流程实时监控平台'等建议获得高赞。法学界人士建议参照食品安全领域惩罚性赔偿制度，对卫生用品消费纠纷实施举证责任倒置。",
      sentiment: 'neutral',
    ...
    },
    {
      ...
      title: '行业标准重构呼声高涨',
      content:
        "舆情分析显示，84.7%的讨论聚焦于标准体系缺陷。现行《一次性使用卫生用品卫生标准》(GB15979-2002)被指存在三大漏洞：未明确生产环境洁净度要求、未规定环氧乙烷残留量检测频率、对材质虚标行为缺乏惩戒条款。中国纺织工业联合会提议将灭菌内裤纳入二类医疗器械管理，实行备案制生产。消费者权益组织则推动'可视化生产'运动，要求企业在产品包装印制灭菌过程二维码。值得注意的是，小米等科技企业被网友呼吁'跨界制定智能卫生标准'，反映出公众对传统监管体系的不信任。专家警示，标准修订需平衡安全性与产业成本，'过度提高标准可能导致小作坊式生产转入地下'。",
      sentiment: 'neutral',
...
[
  ...
  'GET /api/prsuggestions': [
    {
      id: "1",
      title: '供应链透明化与生产审计',
      priority: 'high',
      description:
        '立即公开涉事代工厂名单及整改措施，引入区块链技术实现生产全流程溯源。针对曝光的徒手制作、材料虚标、灭菌标签伪造等问题，需发布第三方审计报告，展示环氧乙烷(EO)灭菌设备实时监控数据',
    },
    {
      id: "2",
      title: '主动召回与三倍赔偿机制',
      priority: 'high',
      description:
        '参照《消费者权益保护法》第五十五条，对2023-2025年间销售的问题产品启动无条件召回，并提供三倍赔偿。建立快速理赔通道处理消费者感染医疗索赔，参考郭晓婷事件引发的群体性信任危机',
    },
    {
      id: "3",
      title: '独立监督委员会组建',
      priority: 'medium',
      description:
        '邀请医学专家、质检机构代表和消费者权益律师成立独立监督委员会，每季度发布《卫生安全白皮书》。重点审查代工模式下的品控漏洞，如揭示的博威服饰「0人参保却生产医疗用品」等资质造假问题}'
    }
    ,
    {
      id: "4",
      ...
      priority: 'high',
      description:
        '制作《一次性卫生用品鉴别指南》短视频系列，通过实验室对比实验揭露涤纶冒充纯棉、灭菌标签真伪识别等核心问题。在电商页面增设「灭菌验证」入口，可扫码查看环氧乙烷灭菌记录',
    },
    {
      id: "5",
      title: '司法责任切割与高管问责',
      priority: 'high',
      description:
        '依据《产品质量法》第十三条，主动配合司法机关追究代工厂刑事责任。对品牌方供应链总监及以上管理人员启动内部问责，公示处分决定以响应揭示的「贴牌即免责」社会质疑',
    },
    {
      id: "6",
      title: '行业标准共建计划',
      priority: 'medium',
      description:
        '联合头部企业制定高于国标的《一次性卫生用品灭菌规范》，推动将「EO灭菌流程」纳入强制认证体系。针对指出的分类模糊问题，申请将产品重新归类为二类医疗器械强化监管',
    },
    {
      id: "7",
      title: 'KOL信任重建合作',
      priority: 'medium',
      description:
        '邀请医学领域权威博主（非娱乐明星）担任「卫生观察员」，直播探访经改造的生产线。重点展示曝光的「枪水喷洒区域」整改成果，用pH试纸现场检测残留物',
    },
    {
      id: "8",
      title: '数字化舆情响应系统',
      priority: 'high',
      description:
        '部署AI情感分析模型实时监测「徒手制作」「黑心棉」等315曝光关键词，建立1小时响应机制。在直播间配置医学专家即时解答灭菌工艺疑问',
    },
  ],


      "GET /api/prsuggestionstw": [
        {
          "id": "1",
